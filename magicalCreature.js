...
let creatureDescription = "A horse with a horn"
...
let randomNumber = (Math.random()* 60) + 1;
let visitorAge = Math.floor(randomNumber);
...
let zooSummary = "creatureName" + "creatureDescription" + "isFriendly" + "randomNumber" + "canVisit"; 
